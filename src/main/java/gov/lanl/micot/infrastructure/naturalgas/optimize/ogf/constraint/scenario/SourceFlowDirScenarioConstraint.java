...
/**
 * A cut that indicates that all nodes that produce flow must have at least one outgoing flow direction variable 
 * 
 
 * @author Russell Bent
 */
public class SourceFlowDirScenarioConstraint implements ConstraintFactory {
   ...
   * @param scenarios
   */
  public SourceFlowDirScenarioConstraint(Collection<Scenario> scenarios) {
  ...
  public static String getConstraintName(Scenario k, NaturalGasNode node) {
    return "SourceDir." + node + "." + k.getIndex();
  }
