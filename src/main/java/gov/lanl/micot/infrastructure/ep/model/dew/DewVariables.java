...
public class DewVariables {
    ...
    dataSources.put(Generator.REAL_GENERATION_A_KEY, DewModelTypeEnum.TEXTFILE_TYPE);
    dataSources.put(Generator.REAL_GENERATION_B_KEY, DewModelTypeEnum.TEXTFILE_TYPE);
    dataSources.put(Generator.REAL_GENERATION_C_KEY, DewModelTypeEnum.TEXTFILE_TYPE);
    dataSources.put(Generator.REACTIVE_GENERATION_KEY, DewModelTypeEnum.TEXTFILE_TYPE);
    dataSources.put(Generator.REACTIVE_GENERATION_A_KEY, DewModelTypeEnum.TEXTFILE_TYPE);
    ...
    dataSources.put(Load.REAL_LOAD_A_MAX_KEY, DewModelTypeEnum.TEXTFILE_FIRST_TYPE);
    dataSources.put(Load.REAL_LOAD_B_MAX_KEY, DewModelTypeEnum.TEXTFILE_FIRST_TYPE);
    dataSources.put(Load.REAL_LOAD_C_MAX_KEY, DewModelTypeEnum.TEXTFILE_FIRST_TYPE);
    dataSources.put(Load.REACTIVE_LOAD_A_MAX_KEY, DewModelTypeEnum.TEXTFILE_FIRST_TYPE);
    dataSources.put(Load.REACTIVE_LOAD_B_MAX_KEY, DewModelTypeEnum.TEXTFILE_FIRST_TYPE);
    dataSources.put(Load.REACTIVE_LOAD_C_MAX_KEY, DewModelTypeEnum.TEXTFILE_FIRST_TYPE);
    ...
    dataSources.put(Generator.REAL_GENERATION_A_KEY, DewModelTypeEnum.LIBRARY_TYPE);
    dataSources.put(Generator.REAL_GENERATION_B_KEY, DewModelTypeEnum.LIBRARY_TYPE);
    dataSources.put(Generator.REAL_GENERATION_C_KEY, DewModelTypeEnum.LIBRARY_TYPE);
    dataSources.put(Generator.REACTIVE_GENERATION_A_KEY, DewModelTypeEnum.LIBRARY_TYPE);
    dataSources.put(Generator.REACTIVE_GENERATION_B_KEY, DewModelTypeEnum.LIBRARY_TYPE);
    dataSources.put(Generator.REACTIVE_GENERATION_C_KEY, DewModelTypeEnum.LIBRARY_TYPE);
    dataSources.put(Load.REAL_LOAD_A_KEY, DewModelTypeEnum.LIBRARY_TYPE);
    dataSources.put(Load.REAL_LOAD_B_KEY, DewModelTypeEnum.LIBRARY_TYPE);
    dataSources.put(Load.REAL_LOAD_C_KEY, DewModelTypeEnum.LIBRARY_TYPE);
    dataSources.put(Load.REACTIVE_LOAD_A_KEY, DewModelTypeEnum.LIBRARY_TYPE);
    dataSources.put(Load.REACTIVE_LOAD_B_KEY, DewModelTypeEnum.LIBRARY_TYPE);
    dataSources.put(Load.REACTIVE_LOAD_C_KEY, DewModelTypeEnum.LIBRARY_TYPE);    
    ...
    phaseSources.put(Generator.REAL_GENERATION_A_KEY, 0);
    phaseSources.put(Generator.REAL_GENERATION_B_KEY, 1);
    phaseSources.put(Generator.REAL_GENERATION_C_KEY, 2);
    phaseSources.put(Generator.REACTIVE_GENERATION_KEY, 0);
    phaseSources.put(Generator.REACTIVE_GENERATION_A_KEY, 0);
    ...
    phaseSources.put(Load.REAL_LOAD_A_MAX_KEY, 0);
    phaseSources.put(Load.REAL_LOAD_B_MAX_KEY, 1);
    phaseSources.put(Load.REAL_LOAD_C_MAX_KEY, 2);
    phaseSources.put(Load.REACTIVE_LOAD_A_MAX_KEY, 0);
    phaseSources.put(Load.REACTIVE_LOAD_B_MAX_KEY, 1);
    phaseSources.put(Load.REACTIVE_LOAD_C_MAX_KEY, 2);
    ...
    phaseSources.put(Generator.REACTIVE_GENERATION_B_KEY, 1);
    phaseSources.put(Generator.REACTIVE_GENERATION_C_KEY, 2);
    phaseSources.put(Load.REAL_LOAD_A_KEY, 0);
    phaseSources.put(Load.REAL_LOAD_B_KEY, 1);
    phaseSources.put(Load.REAL_LOAD_C_KEY, 2);
    phaseSources.put(Load.REACTIVE_LOAD_A_KEY, 0);
    phaseSources.put(Load.REACTIVE_LOAD_B_KEY, 1);
    phaseSources.put(Load.REACTIVE_LOAD_C_KEY, 2);
    ...
    textFileIndicies.put(Load.REAL_LOAD_A_MAX_KEY, new Pair<String,Integer>(DewVariables.DEW_CMPCHN_HEADER, DewVariables.DEW_LOAD_MW_A_IDX));
    textFileIndicies.put(Load.REAL_LOAD_B_MAX_KEY, new Pair<String,Integer>(DewVariables.DEW_CMPCHN_HEADER, DewVariables.DEW_LOAD_MW_B_IDX));
    textFileIndicies.put(Load.REAL_LOAD_C_MAX_KEY, new Pair<String,Integer>(DewVariables.DEW_CMPCHN_HEADER, DewVariables.DEW_LOAD_MW_C_IDX));
    textFileIndicies.put(Load.REACTIVE_LOAD_A_MAX_KEY, new Pair<String,Integer>(DewVariables.DEW_CMPCHN_HEADER, DewVariables.DEW_LOAD_MVAR_A_IDX));
    textFileIndicies.put(Load.REACTIVE_LOAD_B_MAX_KEY, new Pair<String,Integer>(DewVariables.DEW_CMPCHN_HEADER, DewVariables.DEW_LOAD_MVAR_B_IDX));
    textFileIndicies.put(Load.REACTIVE_LOAD_C_MAX_KEY, new Pair<String,Integer>(DewVariables.DEW_CMPCHN_HEADER, DewVariables.DEW_LOAD_MVAR_C_IDX));
    ...
    libraryIndicies.put(Generator.REAL_GENERATION_A_KEY, new Pair<Integer,String>(DewVariables.APPID_RADIAL_POWER_FLOW, DewVariables.PFFKW));
    libraryIndicies.put(Generator.REAL_GENERATION_B_KEY, new Pair<Integer,String>(DewVariables.APPID_RADIAL_POWER_FLOW, DewVariables.PFFKW));
    libraryIndicies.put(Generator.REAL_GENERATION_C_KEY, new Pair<Integer,String>(DewVariables.APPID_RADIAL_POWER_FLOW, DewVariables.PFFKW));
    libraryIndicies.put(Generator.REACTIVE_GENERATION_A_KEY, new Pair<Integer,String>(DewVariables.APPID_RADIAL_POWER_FLOW, DewVariables.PFFKVAR));
    libraryIndicies.put(Generator.REACTIVE_GENERATION_B_KEY, new Pair<Integer,String>(DewVariables.APPID_RADIAL_POWER_FLOW, DewVariables.PFFKVAR));
    libraryIndicies.put(Generator.REACTIVE_GENERATION_C_KEY, new Pair<Integer,String>(DewVariables.APPID_RADIAL_POWER_FLOW, DewVariables.PFFKVAR));
    libraryIndicies.put(Load.REAL_LOAD_A_KEY, new Pair<Integer,String>(DewVariables.APPID_RADIAL_POWER_FLOW, DewVariables.PFFKW));
    libraryIndicies.put(Load.REAL_LOAD_B_KEY, new Pair<Integer,String>(DewVariables.APPID_RADIAL_POWER_FLOW, DewVariables.PFFKW));
    libraryIndicies.put(Load.REAL_LOAD_C_KEY, new Pair<Integer,String>(DewVariables.APPID_RADIAL_POWER_FLOW, DewVariables.PFFKW));
    libraryIndicies.put(Load.REACTIVE_LOAD_A_KEY, new Pair<Integer,String>(DewVariables.APPID_RADIAL_POWER_FLOW, DewVariables.PFFKVAR));
    libraryIndicies.put(Load.REACTIVE_LOAD_B_KEY, new Pair<Integer,String>(DewVariables.APPID_RADIAL_POWER_FLOW, DewVariables.PFFKVAR));
    libraryIndicies.put(Load.REACTIVE_LOAD_C_KEY, new Pair<Integer,String>(DewVariables.APPID_RADIAL_POWER_FLOW, DewVariables.PFFKVAR));
