 ...
 * @author Russell Bent
 */
public class OpenDSSSimulatorFactory implements SimulatorFactory<ElectricPowerModel> {
	
	/**
	 *  Constructor
	 */
	public OpenDSSSimulatorFactory() {		
	}
	
	@Override
	public OpenDSSSimulator createSimulator(SimulatorFlags flags) throws IOException {
	  OpenDSSSimulatorFlags ieissFlags = new OpenDSSSimulatorFlags(flags);
	  OpenDSSSimulator simulator = new OpenDSSSimulator();
		return simulator;
	}
