...
/**
 * This executible exports matpower files
 * @author Russell Bent
 *
 */
public class Powerworld2Matpower {
  ...
  public static void main(String[] args) throws ClassNotFoundException, InstantiationException, IllegalAccessException, IOException {
    ...
    PowerworldModel model = (PowerworldModel) file.readModel(initialFile);
    model.removeZones();
    file.saveMatPowerFile(outputFile, model);
