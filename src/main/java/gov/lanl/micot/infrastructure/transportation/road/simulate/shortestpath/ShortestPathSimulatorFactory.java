 ...
 * @author Russell Bent
 */
public class ShortestPathSimulatorFactory implements SimulatorFactory<RoadModel> {
	
	/**
	 *  Constructor
	 */
	public ShortestPathSimulatorFactory() {		
	}
	
	@SuppressWarnings({ "unchecked", "rawtypes" })
  @Override
	public ShortestPathSimulator createSimulator(SimulatorFlags flags) throws IOException {
		RoadSimulatorFlags newFlags = new RoadSimulatorFlags(flags);
		ShortestPathSimulator simulator = new ShortestPathSimulator();
