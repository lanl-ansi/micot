 ...
 * these variables are the g^s variables in the AAAI 2015 paper
 * 
 * @author Russell Bent
 */
public class ScenarioGeneratorRealPhaseVariableFactory extends ScenarioVariableFactory<ElectricPowerNode, ElectricPowerModel> {
   ...
   * @param scenarios
   */
  public ScenarioGeneratorRealPhaseVariableFactory(Collection<Scenario> scenarios) {
    super(scenarios);
  }
