...
/**
 * variable for determining how much critical reactive load is un met on a per scenario basis
 * 
 * @author Russell Bent
 */
public class ScenarioCriticalReactiveLoadUnMetVariableFactory extends ScenarioVariableFactory<ElectricPowerNode, ElectricPowerModel> {
   ...
   * @param scenarios
   */
  public ScenarioCriticalReactiveLoadUnMetVariableFactory(Collection<Scenario> scenarios) {
    super(scenarios);
  }
  ...
  private String getVariableName(Scenario scenario) {
    return "UnMetCriticalReactiveLoad-" + scenario.getIndex();
  }
