...
/**
 * The amount of reactive load needs to be at least a certain amount, otherwise a variable gets flipped
 * that is used for chance constraints
 * 
 * @author Russell Bent
 */
public class ScenarioChanceConstrainedReactiveLoadMetConstraint extends ScenarioConstraintFactory<ElectricPowerNode, ElectricPowerModel> {
   ...
   * Constraint
   */
  public ScenarioChanceConstrainedReactiveLoadMetConstraint(double percentage, Collection<Scenario> scenarios) {
    super(scenarios);
  ...
  private String getConstraintName(Scenario scenario) {
    return "Reactive Load Chance Constraint Met-" + scenario;
  }
