...
/**
 * variable for determining how much real load is un met on a per scenario basis
 * 
 * @author Russell Bent
 */
public class ScenarioRealLoadUnMetVariableFactory extends ScenarioVariableFactory<ElectricPowerNode, ElectricPowerModel> {
   ...
   * @param scenarios
   */
  public ScenarioRealLoadUnMetVariableFactory(Collection<Scenario> scenarios) {
    super(scenarios);
  }
  ...
  private String getVariableName(Scenario scenario) {
    return "UnMetRealLoad-" + scenario.getIndex();
  }
