...
/**
 * Reactive Generation constraint is discrete than micro grid size and existing generation
 * 
 * @author Russell Bent
 */
public class ScenarioDiscreteReactiveGenerationConstraint extends ScenarioConstraintFactory<ElectricPowerNode, ElectricPowerModel> {

  /**
   * Constraint
   */
  public ScenarioDiscreteReactiveGenerationConstraint(Collection<Scenario> scenarios) {
    super(scenarios);
  }
