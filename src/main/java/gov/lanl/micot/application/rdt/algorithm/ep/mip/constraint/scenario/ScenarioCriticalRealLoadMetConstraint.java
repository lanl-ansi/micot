 ...
 * 
 * This is constraint 12 in the AAAI 2015 paper
 * 
 * @author Russell Bent
 */
public class ScenarioCriticalRealLoadMetConstraint extends ScenarioConstraintFactory<ElectricPowerNode, ElectricPowerModel> {
   ...
   * Constraint
   */
  public ScenarioCriticalRealLoadMetConstraint(double percentage, Collection<Scenario> scenarios) {
    super(scenarios);
  ...
  private String getConstraintName(Scenario scenario) {
    return "Crtical Real Load Met-" + scenario;
  }
