package gov.lanl.micot.application.rdt.algorithm.ep.mip.objective.scenario;
...
/**
 * Adds the scenario reactive load un met variables to the objective function
 * @author Russell Bent
 */
public class ScenarioReactiveLoadUnMetObjectiveFunctionFactory extends ScenarioObjectiveFunctionFactory<ElectricPowerNode, ElectricPowerModel> {

  /**
   * Constructor
   * @param scenarios
   */
  public ScenarioReactiveLoadUnMetObjectiveFunctionFactory(Collection<Scenario> scenarios) {
    super(scenarios);
  }
  
  @Override
  public void addCoefficients(MathematicalProgram program,  ElectricPowerModel model) throws NoVariableException {
    ScenarioReactiveLoadUnMetVariableFactory variableFactory = new ScenarioReactiveLoadUnMetVariableFactory(getScenarios());
