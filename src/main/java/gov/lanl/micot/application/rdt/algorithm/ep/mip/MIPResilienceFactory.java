...
public class MIPResilienceFactory extends OptimizerFactoryImpl<ElectricPowerNode, ElectricPowerModel> {
    ...
    algorithm.addMathProgramFlag(MathematicalProgramFlags.MATHEMATICAL_PROGRAM_FACTORY_FLAG, flags.getString(ElectricPowerMathProgramOptimizerFlags.MATH_PROGRAM_FACTORY_KEY));
