...
/**
 * Flags used for expansion planning algorithms based on a heuristic
 * 
 * @author Russell Bent
 */
public class HeuristicResilienceFlags extends OptimizerFlags {
  ...
  public static final String INNER_MATH_PROGRAM_FACTORY_KEY = INNER_PREFIX + MathematicalProgramFlags.MATHEMATICAL_PROGRAM_FACTORY_FLAG;
	 ...
	 * Constructor
	 */
	public HeuristicResilienceFlags() {
		super();
	 ...
	 * @param flags
	 */
	public HeuristicResilienceFlags(OptimizerFlags flags) {
		super(flags);
