 ...
 * @author Russell Bent
 */
public class LineHardenConstraint extends ScenarioConstraintFactory<ElectricPowerNode, ElectricPowerModel> {

  /**
   * Constructor
   */
  public LineHardenConstraint(Collection<Scenario> scenarios) {
    super(scenarios);
  }
  ...
  private String getName(ElectricPowerFlowConnection edge) {
    return "LineHardenDual." + edge.toString();
  }
