      ...
      for (ElectricPowerNode node : model.getNodes()) {
        for (Load load : node.getComponents(Load.class)) {
          ...
          if (variable != null) {
            ...
            double demand = load.getAttribute(Load.REAL_LOAD_A_MAX_KEY, Number.class).doubleValue();            
            totalLoad += demand;
          }
          ...
          if (variable != null) {
            constraint.addVariable(variable, 1.0);
            double demand = load.getAttribute(Load.REAL_LOAD_B_MAX_KEY, Number.class).doubleValue();
            totalLoad += demand;
          }
          ...
          if (variable != null) {
            constraint.addVariable(variable, 1.0);
            double demand = load.getAttribute(Load.REAL_LOAD_C_MAX_KEY, Number.class).doubleValue();
            totalLoad += demand;
          }
        }
      }
