...
/** 
 * Forces the master problem solution to be a combination of columns for line hardening
 * @author Russell Bent
 */
public class LineHardenColumnConstraint implements ConstraintFactory {
   ...
   * Constraint
   */
  public LineHardenColumnConstraint(Collection<Scenario> scenarios, HashMap<Scenario, ArrayList<Solution>> columns) {    
  ...
  public void constructConstraint(MathematicalProgram problem, ElectricPowerModel model) throws VariableExistsException, NoVariableException, InvalidConstraintException {
    ...
    for (ElectricPowerFlowConnection edge : model.getFlowConnections()) {
      if (hardenFactory.hasVariable(edge)) {      
        Variable variable = hardenFactory.getVariable(problem, edge);
  ...
  private String getName(Scenario scenario, ElectricPowerFlowConnection edge) {
    return "Column-harden." + edge.toString() + "-" + scenario.getIndex();
  }
