 ...
 * @author Russell Bent
 */
public class CriticalLoadConstraint implements ConstraintFactory {
   ...
   * Constraint
   */
  public CriticalLoadConstraint(double percentage, Scenario scenario) {
  ...
  private String getRealName(Scenario scenario, String phase) {
    return "Critical Real Load Met-" + scenario + "." + phase;
  }
  ...
  private String getReactiveName(Scenario scenario, String phase) {
    return "Critical Reactive Load Met-" + scenario + "." + phase;
  }
...
/*    System.out.println(realA);
    ...
    System.out.println(reactiveA);
    System.out.println(reactiveB);
    System.out.println(reactiveC);*/
