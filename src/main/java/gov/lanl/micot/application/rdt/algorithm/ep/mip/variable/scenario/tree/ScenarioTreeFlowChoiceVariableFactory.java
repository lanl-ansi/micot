package gov.lanl.micot.application.rdt.algorithm.ep.mip.variable.scenario.tree;
...
/**
 * Creates a variable for places where we may choose to have a line active
 * (whether through a switch or construction)
 * 
 * @author Russell Bent
 */
public class ScenarioTreeFlowChoiceVariableFactory extends ScenarioVariableFactory<ElectricPowerNode, ElectricPowerModel> {

  /**
   * Constructor
   */
  public ScenarioTreeFlowChoiceVariableFactory(Collection<Scenario> scenarios) {
    super(scenarios);
  }
  ...
  public Variable getVariable(MathematicalProgram program, Object asset) throws NoVariableException {
    throw new NoVariableException("Incorrect usage of TreeFlowChoiceVariableFactory");
  }
