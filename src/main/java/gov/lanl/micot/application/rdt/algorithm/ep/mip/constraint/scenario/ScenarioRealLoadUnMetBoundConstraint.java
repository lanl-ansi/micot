...
/**
 * The amount of load that is unmet only counts when it is above a threshold, otherwise it is 0
 * 
 * @author Russell Bent
 */
public class ScenarioRealLoadUnMetBoundConstraint extends ScenarioConstraintFactory<ElectricPowerNode, ElectricPowerModel> {
   ...
   * Constraint
   */
  public ScenarioRealLoadUnMetBoundConstraint(double percentage, Collection<Scenario> scenarios) {
    super(scenarios);
  ...
  private String getConstraintName(Scenario scenario) {
    return "Real Load Un Met-" + scenario;
  }
  ...
  public void constructConstraint(MathematicalProgram problem, ElectricPowerModel model) throws VariableExistsException, NoVariableException, InvalidConstraintException {
    ...
    ScenarioRealLoadUnMetVariableFactory vFactory = new ScenarioRealLoadUnMetVariableFactory(getScenarios());
