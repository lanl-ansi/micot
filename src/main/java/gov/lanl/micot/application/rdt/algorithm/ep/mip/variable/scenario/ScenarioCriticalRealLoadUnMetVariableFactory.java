...
/**
 * variable for determining how much critical load is un met on a per scenario basis
 * 
 * @author Russell Bent
 */
public class ScenarioCriticalRealLoadUnMetVariableFactory extends ScenarioVariableFactory<ElectricPowerNode, ElectricPowerModel> {
   ...
   * @param scenarios
   */
  public ScenarioCriticalRealLoadUnMetVariableFactory(Collection<Scenario> scenarios) {
    super(scenarios);
  }
  ...
  private String getVariableName(Scenario scenario) {
    return "UnMetCriticalRealLoad-" + scenario.getIndex();
  }
