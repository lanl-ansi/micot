...
/** 
 * Forces the master problem solution to be a combination of columns for line switches
 * @author Russell Bent
 */
public class LineSwitchColumnConstraint implements ConstraintFactory {
   ...
   * Constraint
   */
  public LineSwitchColumnConstraint(Collection<Scenario> scenarios, HashMap<Scenario, ArrayList<Solution>> columns) {    
  ...
  public void constructConstraint(MathematicalProgram problem, ElectricPowerModel model) throws VariableExistsException, NoVariableException, InvalidConstraintException {
    ...
    for (ElectricPowerFlowConnection edge : model.getFlowConnections()) {
      if (switchFactory.hasVariable(edge)) {      
        Variable variable = switchFactory.getVariable(problem, edge);
  ...
  private String getName(Scenario scenario, ElectricPowerFlowConnection edge) {
    return "Column-switch." + edge.toString() + "-" + scenario.getIndex();
  }
