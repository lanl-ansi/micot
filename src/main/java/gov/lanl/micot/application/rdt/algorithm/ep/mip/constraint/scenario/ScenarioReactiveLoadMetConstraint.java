...
/**
 * The amount of reactive load needs to be at least a certain amount
 * 
 * @author Russell Bent
 */
public class ScenarioReactiveLoadMetConstraint extends ScenarioConstraintFactory<ElectricPowerNode, ElectricPowerModel> {
   ...
   * Constraint
   */
  public ScenarioReactiveLoadMetConstraint(double percentage, Collection<Scenario> scenarios) {
    super(scenarios);
  ...
  private String getConstraintName(Scenario scenario) {
    return "Reactive Load Met-" + scenario;
  }
