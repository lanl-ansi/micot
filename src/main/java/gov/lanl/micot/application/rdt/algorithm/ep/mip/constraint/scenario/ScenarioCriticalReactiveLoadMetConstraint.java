...
/**
 * The amount of critical reactive load needs to be at least a certain amount
 * 
 * @author Russell Bent
 */
public class ScenarioCriticalReactiveLoadMetConstraint extends ScenarioConstraintFactory<ElectricPowerNode, ElectricPowerModel> {
   ...
   * Constraint
   */
  public ScenarioCriticalReactiveLoadMetConstraint(double percentage, Collection<Scenario> scenarios) {
    super(scenarios);
  ...
  private String getConstraintName(Scenario scenario) {
    return "Crtical Reactive Load Met-" + scenario;
  }
