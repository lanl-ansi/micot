...
/**
 * Flags used for expansion planning algorithms base on branch and price
 * 
 * @author Russell Bent
 */
public class BPResilienceFlags extends OptimizerFlags {
  ...
  public static final String INNER_MATH_PROGRAM_FACTORY_KEY = INNER_PREFIX + MathematicalProgramFlags.MATHEMATICAL_PROGRAM_FACTORY_FLAG;
	 ...
	 * @param flags
	 */
	public BPResilienceFlags(OptimizerFlags flags) {
		super(flags);
