 ...
 * @author Russell Bent
 */
public class ScenarioRealLoadPhaseVariableFactory extends ScenarioVariableFactory<ElectricPowerNode, ElectricPowerModel> {
   ...
   * @param scenarios
   */
  public ScenarioRealLoadPhaseVariableFactory(Collection<Scenario> scenarios) {
    super(scenarios);
  }
