 ...
 * @author Russell Bent
 */
public class ScenarioChanceConstrainedCriticalRealLoadMetConstraint extends ScenarioConstraintFactory<ElectricPowerNode, ElectricPowerModel> {
   ...
   * Constraint
   */
  public ScenarioChanceConstrainedCriticalRealLoadMetConstraint(double percentage, Collection<Scenario> scenarios) {
    super(scenarios);
  ...
  private String getConstraintName(Scenario scenario) {
    return "Crtical Chance Constraint Real Load Met-" + scenario;
  }
