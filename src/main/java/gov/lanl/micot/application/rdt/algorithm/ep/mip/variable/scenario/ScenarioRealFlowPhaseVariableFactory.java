 ...
 * @author Russell Bent
 */
public class ScenarioRealFlowPhaseVariableFactory extends ScenarioVariableFactory<ElectricPowerNode, ElectricPowerModel> {
   ...
   * Constructor
   */
  public ScenarioRealFlowPhaseVariableFactory(Collection<Scenario> scenarios) {
    super(scenarios);
  }
