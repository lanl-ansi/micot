...
/**
 * Tests of LPNORM functionaility using the SBD technique
 * @author Russell Bent
 *
 */
public class LPNormSBDTest  extends TestCase {
  ...
  public void testNetworkFlow() throws IOException, InstantiationException, IllegalAccessException, ClassNotFoundException {
    ...
    String filename = "application_data" + File.separatorChar + "lpnorm" + File.separatorChar + "junit" + File.separatorChar + "network_flow_sbd.json";
