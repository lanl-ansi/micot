...
/**
 * Tests of LPNORM functionaility using the full blown MIP
 * @author Russell Bent
 *
 */
public class LPNormMIPTest  extends TestCase {
  ...
  public void testNetworkFlow() throws IOException, InstantiationException, IllegalAccessException, ClassNotFoundException {
    ...
    String filename = "application_data" + File.separatorChar + "lpnorm" + File.separatorChar + "junit" + File.separatorChar + "network_flow_mip.json";
