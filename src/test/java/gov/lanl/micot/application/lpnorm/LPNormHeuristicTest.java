...
/**
 * Tests of LPNORM functionaility using the heuristic technique
 * @author Russell Bent
 *
 */
public class LPNormHeuristicTest  extends TestCase {
  ...
  public void testNetworkFlow() throws IOException, InstantiationException, IllegalAccessException, ClassNotFoundException {
    ...
    String filename = "application_data" + File.separatorChar + "lpnorm" + File.separatorChar + "junit" + File.separatorChar + "network_flow_heuristic.json";
