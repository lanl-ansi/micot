...
public class RobustEPHardenTest1Scip extends TestCase {
  ...
  public void testHardenMIPCycleContiniousDetermineScip() throws IOException, InstantiationException, IllegalAccessException, ClassNotFoundException {
   ...
   /* String masterFile = "config_files" + File.separatorChar + "Resilience" + File.separatorChar + "34Bus" + File.separatorChar + "Ice Harden" + File.separatorChar + "Rural" + File.separatorChar + "0.75% Per Mile Damage" + File.separatorChar + "config-mip-cycle-continous-deterimine-scip.json";
    ...
    assertEquals(3411, -objValue, 1.0);*/
  }
