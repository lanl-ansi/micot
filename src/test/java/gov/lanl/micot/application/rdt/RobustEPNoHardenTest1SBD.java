...
public class RobustEPNoHardenTest1SBD extends TestCase {
   ...
   */
  public void testNoHardenMIPCycleContinousDetermine() throws IOException, InstantiationException, IllegalAccessException, ClassNotFoundException {
 ...
 /*   String masterFile = "config_files" + File.separatorChar + "Resilience" + File.separatorChar 
        ...
        + "config-cycle-continious-determine-sbd.json";
    ...
    assertEquals(2891.0998, -objValue, 1.0);
